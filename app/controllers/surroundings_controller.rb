class SurroundingsController < ApplicationController
  ...
  def show
    ...
    @photo_groups = @photos.in_groups_of(3, false)
  ...
  def create
    ...
    respond_to do |format|
      if @surrounding.save
        format.html { redirect_to '/surroundings/1/', notice: 'Surrounding was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @surrounding.update(surrounding_params)
        format.html { redirect_to '/surroundings/1/', notice: 'Surrounding was successfully updated.' }
